...
touch /etc/php/5.6/conf.d/ioncube.ini
echo "zend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" > /etc/php/5.6/apache2/conf.d/ioncube.ini
sed -i "1izend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" /etc/php/5.6/apache2/php.ini
sleep 3s
